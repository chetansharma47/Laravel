    ...
    t.extend(d.prototype, {
        init: function() {
            var e = t(this.element),
                ...
                s = t('<header><h2 class="month"></h2><a class="simple-calendar-btn btn-prev prev_nxt_btn_month" ui="previous" click_on = "false" href="javascript:void(0);"></a><a class="simple-calendar-btn btn-next prev_nxt_btn_month" ui="next" click_on = "false" href="javascript:void(0);"></a></header>');
        ...
        buildCalendar: function(e, n) {
            ...
            for (var c = l; c < l + 7; c++) s.append(t("<td>" + this.settings.days[c % 7].substring(0, 3) + "</td>"));
            for (var v = o; v <= h; v.setDate(v.getDate())) {
                var u = t("<tr></tr>");
                for (c = 0; c < 7; c++) {
                    var g = t('<td><div class="day" data-date="' + v.toISOString() + '">' + v.getDate() + "</div></td>"),
                        f = g.find(".day");
                    v.toDateString() === (new Date).toDateString() && f.addClass("today"), v.getMonth() != e.getMonth() && f.addClass("wrong-month");
                    var D = this.getDateEvents(v);
                    D.length && this.settings.displayEvent ? f.addClass(this.settings.disableEventDetails ? "has-event disabled" : "has-event") : f.addClass(this.settings.disableEmptyDetails ? "disabled" : ""), f.data("todayEvents", D), this.settings.onDayCreate(f, v.getDate(), r, d), u.append(g), v.setDate(v.getDate() + 1)
                }
                i.append(u)
            }
