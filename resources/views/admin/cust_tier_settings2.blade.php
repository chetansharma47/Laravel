				...
				<div class="col-md-9 padding-top" style="padding-top: 20px">
					...
					<div class="row pr-5 pl-3 mt-0">
						<div class="col-md-3 venue_inputs">
							...
							<input type="number" class="form-control form-control-user" placeholder="From Amount" value="5001" />
						</div>
						<div class="col-md-3 venue_inputs">
							<label>
								To Amount
							</label>
							<input type="number" class="form-control form-control-user" placeholder="To Amount" value="10001" />
						</div>
					</div>
					<div class="row pr-5 pl-3 mt-5">
						<div class="col-md-3 venue_inputs">
							...
							<input type="email" class="form-control form-control-user" placeholder="Color Code for Customer Tier" value="#FF9900 " />
						</div>
					</div>
