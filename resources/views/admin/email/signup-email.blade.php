...
<body style="background-color: #f9fafb; padding: 0;
  ...
  <tr>
    <td width="20" align="left" valign="top">
      ...
      <?php 
        ...
        $welcome_to_capitalmotion_loyalty_top_curve = public_path("admin/assets/email_img/Welcome_to_capitalmotion_loyalty_top_curve.png");
       ?>

      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="border-top-left-radius: 30px; border-top-right-radius: 30px; background-color: #fff;">
        <img src="{{$message->embed($welcome_to_capitalmotion_loyalty_top_curve)}}" alt="" style="border-top-left-radius: 30px;border-top-right-radius: 30px; width: 442px;" />
     ...
     font-weight: 700; color: #fff; padding-bottom: 17px;">
            {{$admin_signup_notification_email->title}}
          </td>
          <td width="20" align="left" valign="top">&nbsp;</td>
        </tr> -->
    </table>
  ...
  <tr>
    <td align="left" valign="top" style="background:#fff; padding:30px 20px;border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">
     ...
     font-weight: 700; font-size: 15px; color:#0D0D0D;">Hello, {{$user->first_name}} {{$user->last_name}}</b></td>
          </tr>
          <tr>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" style="background-color: #0b68ac; width: 100%; padding: 30px 0px 2px; margin-top: 82px;">
  ...
  <tr>
    ...
    <!-- Hi welcome your registerartion has been done successfully and you will get bonus upto 5000. -->
  </tr>
</table>
</body>
</html>
