...
<body style="background-color: #f9fafb; padding: 0;
  ...
  <tr>
    <td width="20" align="left" valign="top">
      ...
      <?php 
        ...
        $referral_bonus_notification_top_curve = public_path("admin/assets/email_img/referral_bonus_notification_top_curve.png");
       ?>

      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="border-top-left-radius: 30px; border-top-right-radius: 30px; background-color: #fff;">
        <img src="{{$message->embed($referral_bonus_notification_top_curve)}}" alt="" style="border-top-left-radius: 30px;border-top-right-radius: 30px; width: 442px;" />
  ...
  <tr>
    <td align="left" valign="top" style="background:#fff; padding:30px 20px;border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">
     ...
     font-weight: 700; font-size: 15px; color:#0D0D0D;">Hello, {{$refer_user_find->first_name}} {{$refer_user_find->last_name}}</td>
          </tr>
          <tr>
