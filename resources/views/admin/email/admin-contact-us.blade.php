...
<body style="background-color: #f9fafb; padding: 0;
  ...
  <tr>
    <td width="20" align="left" valign="top">
      ...
      <?php 
        ...
        $contact_us_top_curve = public_path("admin/assets/email_img/contact_us_top_curve.png");
       ?>

      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="border-top-left-radius: 30px; border-top-right-radius: 30px; background-color: #fff;">
        <img src="{{$message->embed($contact_us_top_curve)}}" alt="" style="border-top-left-radius: 30px;border-top-right-radius: 30px; width: 442px;" />
  ...
  <tr>
    <td align="left" valign="top" style="background:#fff; padding:30px 20px;border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">
     ...
     font-weight: 700; font-size: 15px; color:#0D0D0D;">Hello, Admin</b></td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Lato', sans-serif;
     font-weight: 500; font-size: 15px; color:#0D0D0D;">Please check a new report from following user</b></td>
          </tr>
          <tr>
            <td align="left" valign="top" style="font-family: 'Lato', sans-serif;
     font-weight: 400; font-size: 15px; color:#0D0D0D;">User name: {{$user->first_name}} {{$user->last_name}}</b></td>
          </tr>
          <tr>
            <td align="left" valign="top" style="font-family: 'Lato', sans-serif;
     font-weight: 400; font-size: 15px; color:#0D0D0D;">User email: {{$user->email}} </b></td>
          </tr>
          <tr>
            <td align="left" valign="top" style="font-family: 'Lato', sans-serif;
     font-weight: 400; font-size: 15px; color:#0D0D0D;">User mobile number: {{$user->mobile_number}} </b></td>
          </tr>
          <tr>
            <td align="left" valign="top">&nbsp;</td>
          </tr>
          ...
          <tr>
            <td align="left" valign="top" style="font-family: 'Lato', sans-serif;
     font-weight: 400; font-size:14px; color:#474747;">Message: {{$data['message']}}
            </td>
          </tr>
          <tr>
