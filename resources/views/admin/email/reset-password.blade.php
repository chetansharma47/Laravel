...
<body style="background-color: #f9fafb; padding: 0;
  ...
  <tr>
    ...
    z-index: 99;
        margin-top: 20px;
        margin-left: -32px;" /> -->
            <label id="new_password-error" style="display: none;" class="error err" for="new_password"></label>
            </td>
          </tr>
          <tr>
            <td align="center" valign="top" style="font-family: 'Signika', sans-serif;
  ...
  $(document).ready(function(){
    ...
    $("#submit_btn").on("click",function(){
      ...
      if(new_password.length <= 5){
        $("#new_password-error").text("New password must be at least 6 characters long.").show();
        validate = "true";
      }else{
        $("#new_password-error").text("").hide();
      }

      if(new_password == ""){
        $("#new_password-error").text("Please enter new password.").show();
        validate = "true";
      }
