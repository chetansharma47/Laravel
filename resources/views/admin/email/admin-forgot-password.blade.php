...
<body style="background-color: #f9fafb; padding: 0;
  ...
  <tr>
    <td width="20" align="left" valign="top">
      <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="background-image: url(.public/admin/assets/email_img/curve-bg.png); background-repeat: no-repeat; background-size: cover; border-top-left-radius: 30px;border-top-right-radius: 30px;     background-position: bottom;">
        
        <tr>
          <td width="20" align="left" valign="top">&nbsp;</td>
          <td align="center" valign="top" style="padding:5px 0;">
          	<a href="javascript:void(0);" style="border:0; outline:0;">
              <?php $img_second = public_path("admin/assets/email_img/CR-Logo.png");
                $img_third = public_path("admin/assets/email_img/CM-Logo-2.png");
               ?>
              <img src="{{$img_second}}" alt="CR-Logo" width="100"/>
            </a>
          </td>
          <td width="20" align="left" valign="top">&nbsp;</td>
        </tr>
