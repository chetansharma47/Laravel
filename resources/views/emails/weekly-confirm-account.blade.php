  ...
  <tr>
    <td width="20" align="left" valign="top">
      ...
      <?php 
        ...
        $weekly_verify_email_top_curve = public_path("admin/assets/email_img/weekly_verify_email_top_curve.png");
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <img src="{{$message->embed($weekly_verify_email_top_curve)}}" alt="" style="border-top-left-radius: 30px;border-top-right-radius: 30px; width: 442px;" />
